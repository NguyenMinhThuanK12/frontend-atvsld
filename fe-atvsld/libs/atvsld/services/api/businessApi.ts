...
export const getBusinesses = async (): Promise<paginationResponse<Business>> => {
  try {
    console.log("Fetching businesss...");
    
    const response = await api.get<ApiResponse<paginationResponse<Business>>>("/businesses");
...
export const getBusinessById = async (id: string): Promise<ApiResponse<Business>> => {
    try {
...
export const createBusiness = async (business: CreationBusinessRequest): Promise<ApiResponse<Business>> => {
  try {
      ...
      formData.append(
        ...
        business.establishedDate
          ? format(business.establishedDate, "yyyy-MM-dd")
          : ""
      );
      ...
      if (business.businessLicenseFile instanceof File) {
        formData.append("businessLicenseFile", business.businessLicenseFile);
      }
      if (business.otherDocumentFile instanceof File) {
        formData.append("otherDocumentFile", business.otherDocumentFile);
      }
...
export const deleteBusiness = async (id: string): Promise<ApiResponse<null>> => {
  try {
